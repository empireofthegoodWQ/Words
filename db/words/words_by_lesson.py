...
async def get_words_by_lesson(
    ...
    """
    Асинхронно извлекает все слова из таблицы 'words' для заданного урока.
    ...
    Returns:
        Словарь, где ключ - слово (word), а значение - перевод (translation).
        Пример: {"word1": "translation1", "word2": "translation2"}.
    ...
    try:
        ...
        async with conn.cursor() as cur:
            ...
            sql = "SELECT word, translation FROM words WHERE lesson = %s"
            val = (lesson,)
